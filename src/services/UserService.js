...
export const getAllUser = async (access_token) => {
    // console.log('getAllUser access_token',access_token);
...
export const deleteUser = async (id, access_token) => {
    ...
    console.log('data res deleteUser', res);
    return res.data
}
export const getDetailsUser = async (id, access_token) => {
    // console.log('access_token getDetailsUser',access_token);
...
export const deleteManyUser = async (data, access_token) => {
    // console.log('deleteProduct',id,access_token);
